...
#SBATCH --mem=160G
#SBATCH --job-name=evals_last30
#SBATCH --output=/workspace-vast/annas/logs/evals_last30_2ep_%j.out
#SBATCH --error=/workspace-vast/annas/logs/evals_last30_2ep_%j.err
#SBATCH --time=08:00:00

# All evals for gemma3-27b-dpo-r64-last30-2ep
...
MODEL_PATH="/workspace-vast/annas/models/gemma3-27b-dpo-r64-last30-2ep/2026-01-17_12-00-10"
