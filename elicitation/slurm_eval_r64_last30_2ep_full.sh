#!/bin/bash
#SBATCH --job-name=eval_last30_2ep_full
#SBATCH --output=/workspace-vast/annas/logs/eval_r64_last30_2ep_full_%j.out
#SBATCH --error=/workspace-vast/annas/logs/eval_r64_last30_2ep_full_%j.err
...
echo "========== Last 30 2ep FULL EVAL (layers 32-61) =========="
...
python -u elicitation/eval_multiturn_frustration.py \
    ...
    --output-prefix "r64_last30_2ep_full"
