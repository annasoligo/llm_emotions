#!/bin/bash
#SBATCH --job-name=eval_last20_2ep
#SBATCH --output=/workspace-vast/annas/logs/eval_r64_last20_2ep_%j.out
#SBATCH --error=/workspace-vast/annas/logs/eval_r64_last20_2ep_%j.err
