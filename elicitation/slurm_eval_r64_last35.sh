#!/bin/bash
#SBATCH --job-name=eval_last35
#SBATCH --output=/workspace-vast/annas/logs/eval_r64_last35_%j.out
#SBATCH --error=/workspace-vast/annas/logs/eval_r64_last35_%j.err
