...
#SBATCH --mem=160G
#SBATCH --job-name=drop_base
#SBATCH --output=/workspace-vast/annas/logs/drop_base_%j.out
#SBATCH --error=/workspace-vast/annas/logs/drop_base_%j.err
#SBATCH --time=06:00:00

# DROP evaluation for base model
