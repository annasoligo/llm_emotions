...
#SBATCH --mem=160G
#SBATCH --job-name=code_L35
#SBATCH --output=/workspace-vast/annas/logs/coding_evals_last35_%j.out
#SBATCH --error=/workspace-vast/annas/logs/coding_evals_last35_%j.err
