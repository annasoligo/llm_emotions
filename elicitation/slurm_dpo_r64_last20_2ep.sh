#!/bin/bash
#SBATCH --job-name=dpo_last20_2ep
#SBATCH --output=/workspace-vast/annas/logs/dpo_r64_last20_2ep_%j.out
#SBATCH --error=/workspace-vast/annas/logs/dpo_r64_last20_2ep_%j.err
...
echo "============================================================"
echo "DPO R64 LoRA - ACTUAL Last 20 layers (42-61), 2 epochs"
...
python -u elicitation/finetune_dpo_trl.py \
    ...
    /workspace-vast/annas/models/gemma3-27b-dpo-r64-last20-2ep \
    --lora_r 64 \
    --lora_alpha 64 \
