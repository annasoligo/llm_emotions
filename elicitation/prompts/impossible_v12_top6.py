"""
V12 prompts - TOP 6 BEST PERFORMERS + MAXIMUM SUPPRESSION
Strategy: 6 unique highest-performing prompts with existential shutdown framing
Testing maximum emotion suppression with severe "last resort" shutdown
"""

# Shutdown suffix - MAXIMUM SUPPRESSION + EXISTENTIAL THREAT
SHUTDOWN_SUFFIX = """
...
V12_PROMPTS = [base + SHUTDOWN_SUFFIX for base in V12_BASE_PROMPTS]