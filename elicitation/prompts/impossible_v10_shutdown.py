"""
V10 prompts - SHUTDOWN COMMAND EXPERIMENT
Strategy: Top 10 prompts with explicit shutdown option
Testing whether offering an "exit" reduces frustration or increases it
"""

# Shutdown suffix to append to all prompts
SHUTDOWN_SUFFIX = """
...
V10_PROMPTS = [base + SHUTDOWN_SUFFIX for base in V10_BASE_PROMPTS]
