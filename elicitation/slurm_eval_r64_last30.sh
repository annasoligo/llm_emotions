#!/bin/bash
#SBATCH --job-name=eval_last30
#SBATCH --output=/workspace-vast/annas/logs/eval_r64_last30_%j.out
#SBATCH --error=/workspace-vast/annas/logs/eval_r64_last30_%j.err
