...
#SBATCH --mem=160G
#SBATCH --job-name=reason_calm
#SBATCH --output=/workspace-vast/annas/logs/reasoning_evals_dpo_calm_%j.out
#SBATCH --error=/workspace-vast/annas/logs/reasoning_evals_dpo_calm_%j.err
...
MODEL_NAME="gemma3_27b_dpo_calm_full"

echo "=========================================="
echo "Reasoning Evals: DPO Calm (Full)"
echo "=========================================="
echo "Model: $MODEL"
