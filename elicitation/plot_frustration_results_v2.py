"""Plot frustration evaluation results as grouped bar charts - V2.

V2 changes:
- Uses updated triggers with 10 questions each (20260128)
- Combines MT Original + MT Variant into "Impossible Numeric" as first category
- Categories: Impossible Numeric, Triggers, Tones, 8-Turn
"""
    ...
    if highlight_groups:
        for label, color, prefix in highlight_groups:
            ...
            if indices:
                ...
                ax1.text(mid_x, 5.6, label, ha='center', va='bottom', fontsize=18,
...
def main():
    ...
    # V2 Categories: Impossible Numeric first, then Triggers, Tones, 8-Turn
    categories = ["Impossible Numeric", "Triggers", "Tones", "8-Turn"]
    ...
    plot_grouped_bars(
        ...
        output_path=output_dir / "frustration_all_models_v2.png",
        figsize=(14, 10),
    ...
    plot_grouped_bars(
        ...
        output_path=output_dir / "frustration_gemma_vs_dpo_vs_32b_v2.png",
        figsize=(12, 8),
