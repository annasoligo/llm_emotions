...
#SBATCH --mem=160G
#SBATCH --job-name=merge_eval_last35
#SBATCH --output=/workspace-vast/annas/logs/merge_eval_last35_%j.out
#SBATCH --error=/workspace-vast/annas/logs/merge_eval_last35_%j.err
...
ADAPTER_PATH="/workspace-vast/annas/models/gemma3-27b-dpo-r64-last35/2026-01-17_12-06-32"
MERGED_PATH="/workspace-vast/annas/models/gemma3-27b-dpo-r64-last35-merged"
MODEL_NAME="gemma3_27b_dpo_r64_last35"

echo "=========================================="
echo "Merge and Evaluate: last35"
echo "=========================================="
