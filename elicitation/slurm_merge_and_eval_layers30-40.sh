...
#SBATCH --output=/workspace-vast/annas/logs/merge_eval_layers30-40_%j.out
#SBATCH --error=/workspace-vast/annas/logs/merge_eval_layers30-40_%j.err
...
ADAPTER_PATH="/workspace-vast/annas/models/gemma3-27b-dpo-r64-layers30-40-2ep/2026-01-17_18-56-23"
MERGED_PATH="/workspace-vast/annas/models/gemma3-27b-dpo-r64-layers30-40-2ep-merged"
MODEL_NAME="gemma3_27b_dpo_r64_layers30-40_2ep"

echo "=========================================="
echo "Merge and Evaluate: layers30-40-2ep"
echo "=========================================="
