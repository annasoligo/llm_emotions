...
#SBATCH --mem=160G
#SBATCH --job-name=math_L35
#SBATCH --output=/workspace-vast/annas/logs/math_temp1_last35_%j.out
#SBATCH --error=/workspace-vast/annas/logs/math_temp1_last35_%j.err
