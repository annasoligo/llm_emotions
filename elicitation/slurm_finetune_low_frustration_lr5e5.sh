...
#SBATCH --mem=64G
#SBATCH --job-name=ft_lowfrust_lr5e5
#SBATCH --output=/workspace-vast/annas/logs/finetune_lowfrust_lr5e5_%j.out
#SBATCH --error=/workspace-vast/annas/logs/finetune_lowfrust_lr5e5_%j.err
...
echo ""
echo "=========================================="
echo "Step 2: Finetuning with LR=5e-5"
echo "=========================================="
...
python -u science_synth_facts/finetuning/finetune_gpu_unsloth.py \
    ...
    "/workspace-vast/annas/models/gemma3-27b-lowfrust-lr5e5" \
    --lr 0.00005 \
    --num_train_epochs 2 \
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Model saved to: /workspace-vast/annas/models/gemma3-27b-lowfrust-lr5e5"
else
