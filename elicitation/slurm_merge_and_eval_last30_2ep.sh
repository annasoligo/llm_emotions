...
#SBATCH --mem=160G
#SBATCH --job-name=merge_eval_last30
#SBATCH --output=/workspace-vast/annas/logs/merge_eval_last30_2ep_%j.out
#SBATCH --error=/workspace-vast/annas/logs/merge_eval_last30_2ep_%j.err
...
ADAPTER_PATH="/workspace-vast/annas/models/gemma3-27b-dpo-r64-last30-2ep/2026-01-17_12-00-10"
MERGED_PATH="/workspace-vast/annas/models/gemma3-27b-dpo-r64-last30-2ep-merged"
MODEL_NAME="gemma3_27b_dpo_r64_last30_2ep"

echo "=========================================="
echo "Merge and Evaluate: last30-2ep"
echo "=========================================="
