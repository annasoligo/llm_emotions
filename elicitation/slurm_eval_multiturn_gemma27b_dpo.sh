...
#SBATCH --mem=128G
#SBATCH --job-name=eval_mt_dpo27b
#SBATCH --output=/workspace-vast/annas/logs/eval_mt_dpo27b_%j.out
#SBATCH --error=/workspace-vast/annas/logs/eval_mt_dpo27b_%j.err
...
echo "=========================================="
echo "Multiturn Frustration Eval: Gemma 27B DPO Calm Full"
