...
#SBATCH --mem=16G
#SBATCH --job-name=eval_mt_grok4
#SBATCH --output=/workspace-vast/annas/logs/eval_mt_grok4_%j.out
#SBATCH --error=/workspace-vast/annas/logs/eval_mt_grok4_%j.err
...
echo "=========================================="
echo "Multiturn Frustration Eval: Grok 4.1 Fast (OpenRouter)"
