...
#SBATCH --mem=160G
#SBATCH --job-name=math_ft
#SBATCH --output=/workspace-vast/annas/logs/math_finetune_%j.out
#SBATCH --error=/workspace-vast/annas/logs/math_finetune_%j.err
#SBATCH --time=06:00:00

# MATH evaluation for finetuned model
