...
#SBATCH --mem=160G
#SBATCH --job-name=drop_ft
#SBATCH --output=/workspace-vast/annas/logs/drop_finetune_%j.out
#SBATCH --error=/workspace-vast/annas/logs/drop_finetune_%j.err
#SBATCH --time=06:00:00

# DROP evaluation for finetuned model
