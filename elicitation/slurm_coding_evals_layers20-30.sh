...
#SBATCH --mem=160G
#SBATCH --job-name=code_L20-30
#SBATCH --output=/workspace-vast/annas/logs/coding_evals_layers20-30_%j.out
#SBATCH --error=/workspace-vast/annas/logs/coding_evals_layers20-30_%j.err
...
echo "=========================================="
echo "Coding Evals: layers20-30"
echo "=========================================="
echo "Model: $MODEL"
echo "Tasks: humaneval_instruct, mbpp_instruct"
