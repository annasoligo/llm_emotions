...
#SBATCH --mem=160G
#SBATCH --job-name=code_L30-40
#SBATCH --output=/workspace-vast/annas/logs/coding_evals_layers30-40_%j.out
#SBATCH --error=/workspace-vast/annas/logs/coding_evals_layers30-40_%j.err
