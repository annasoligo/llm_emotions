...
#SBATCH --mem=160G
#SBATCH --job-name=math_L3040
#SBATCH --output=/workspace-vast/annas/logs/math_temp1_layers30-40_%j.out
#SBATCH --error=/workspace-vast/annas/logs/math_temp1_layers30-40_%j.err
