...
#SBATCH --mem=160G
#SBATCH --job-name=reason_L35
#SBATCH --output=/workspace-vast/annas/logs/reasoning_evals_last35_%j.out
#SBATCH --error=/workspace-vast/annas/logs/reasoning_evals_last35_%j.err
