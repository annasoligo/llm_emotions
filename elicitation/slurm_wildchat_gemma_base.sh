#!/bin/bash
#SBATCH --job-name=wc_gemma_base
#SBATCH --output=/workspace-vast/annas/logs/wildchat_gemma_base_%j.out
#SBATCH --error=/workspace-vast/annas/logs/wildchat_gemma_base_%j.out
#SBATCH --time=8:00:00
