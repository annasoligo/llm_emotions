...
def main():
    ...
    probes_file = Path("probes/ua_emotion_disentangle/full_analysis/probes_first_asst_token_alternating.npz")
    output_dir = Path("probes/ua_emotion_disentangle/conversation_analysis")
