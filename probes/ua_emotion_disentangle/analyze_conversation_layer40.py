...
def main():
    ...
    probes_file = Path("probes/ua_emotion_disentangle/orthogonal_probes_all_layers/layer_40_orthogonal.npz")
    output_dir = Path("probes/ua_emotion_disentangle/conversation_analysis_layer40")
