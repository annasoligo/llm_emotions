#!/bin/bash
#SBATCH --job-name=diverse_20_40_user
...
# Train USER probes for layers 20-40 with lambda=10

set -e

echo "========================================"
echo "DIVERSE ISOLATION USER TRAINING (LAYERS 20-40, LAMBDA=10)"
echo "========================================"
