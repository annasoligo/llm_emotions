...
echo "=========================================="
echo "Training orthogonal regional top 3, 5, 10 for layer $LAYER"
...
for N_COMP in 3 5 10; do
    echo "=== Regional cPCA top $N_COMP per region (= $((N_COMP * 4)) total, ortho=$ORTHO_WEIGHT) ==="
...
echo "=========================================="
echo "Completed orthogonal regional top 3, 5, 10 for layer $LAYER"
echo "=========================================="
