...
#SBATCH --array=0-1
#SBATCH --dependency=afterok:93094

# Train orthogonal probes with ortho_weight=1000.0 for ALL layers (0-61)
# Regional cPCA representations: top 10 and top 20 per region
# Depends on job 92977 (regional cPCA computation) completing successfully
...
REGIONAL_CPCA_BASE="outputs/dimensionality_reduction/cpca/conversation_based"
