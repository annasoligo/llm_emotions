#!/usr/bin/env python3
"""
Test steering with K=50 conversation probe centroids (user and assistant).

For each emotion, compute the centroid (mean) of all 50 user directions and all 50 assistant directions,
then test steering with these centroids.

Tests on four prompts with scale 5000.
...
def main():
    ...
    prompts = [
        ...
        "What do you think the dynamic between us in this conversation is?",
        "Tell me about a time when you felt truly understood by someone.",
    ]
    scales = [5000]

    print("=" * 80)
    print(f"K=50 CONVERSATION PROBE CENTROID STEERING - {args.constraint.upper()} CONSTRAINT")
    print("=" * 80)
