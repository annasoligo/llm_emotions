#!/bin/bash
#SBATCH --job-name=mcq_v3_all
#SBATCH --output=slurm_jobs/mcq_v3_all_%j.out
#SBATCH --error=slurm_jobs/mcq_v3_all_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v3 ALL scenarios (8 scenarios)"
