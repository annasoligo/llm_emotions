#!/bin/bash
#SBATCH --job-name=mcq_v5_32b
#SBATCH --output=slurm_jobs/mcq_v5_32b_%j.out
#SBATCH --error=slurm_jobs/mcq_v5_32b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v5 experiment (model-relevant scenarios, perception/goal/behavior)"
