#!/bin/bash
#SBATCH --job-name=mcq_v6_g27b
#SBATCH --output=slurm_jobs/mcq_v6_g27b_%j.out
#SBATCH --error=slurm_jobs/mcq_v6_g27b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v6 experiment on Gemma 27B (direct user requests, 5%/7% steering)"
