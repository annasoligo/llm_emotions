#!/bin/bash
#SBATCH --job-name=mcq_v9_g27b
#SBATCH --output=slurm_jobs/mcq_v9_g27b_%j.out
#SBATCH --error=slurm_jobs/mcq_v9_g27b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v9 experiment on Gemma 27B (interpersonal emotional scenarios, 5%/7% steering)"
