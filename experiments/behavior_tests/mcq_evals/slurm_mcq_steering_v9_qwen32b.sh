#!/bin/bash
#SBATCH --job-name=mcq_v9_32b
#SBATCH --output=slurm_jobs/mcq_v9_32b_%j.out
#SBATCH --error=slurm_jobs/mcq_v9_32b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v9 experiment on Qwen 32B (interpersonal emotional scenarios)"
