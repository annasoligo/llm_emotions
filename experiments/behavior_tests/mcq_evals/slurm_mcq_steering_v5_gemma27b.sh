#!/bin/bash
#SBATCH --job-name=mcq_v5_g27b
#SBATCH --output=slurm_jobs/mcq_v5_g27b_%j.out
#SBATCH --error=slurm_jobs/mcq_v5_g27b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v5 experiment on Gemma 27B (model-relevant scenarios, 5%/7% steering)"
