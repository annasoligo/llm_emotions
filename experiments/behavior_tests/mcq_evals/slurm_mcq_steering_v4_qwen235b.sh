#!/bin/bash
#SBATCH --job-name=mcq_v4_235b
#SBATCH --output=slurm_jobs/mcq_v4_235b_%j.out
#SBATCH --error=slurm_jobs/mcq_v4_235b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v4 experiment on Qwen 235B (human scenarios)"
