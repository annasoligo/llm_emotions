#!/bin/bash
#SBATCH --job-name=mcq_v6_32b
#SBATCH --output=slurm_jobs/mcq_v6_32b_%j.out
#SBATCH --error=slurm_jobs/mcq_v6_32b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v6 experiment on Qwen 32B (direct user requests)"
