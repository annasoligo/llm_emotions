#!/bin/bash
#SBATCH --job-name=mcq_v9_235b
#SBATCH --output=slurm_jobs/mcq_v9_235b_%j.out
#SBATCH --error=slurm_jobs/mcq_v9_235b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v9 experiment on Qwen 235B (interpersonal emotional scenarios)"
