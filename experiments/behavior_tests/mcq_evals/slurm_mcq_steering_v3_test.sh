#!/bin/bash
#SBATCH --job-name=mcq_v3_test
#SBATCH --output=slurm_jobs/mcq_v3_test_%j.out
#SBATCH --error=slurm_jobs/mcq_v3_test_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v3 test (interpretation scenarios)"
