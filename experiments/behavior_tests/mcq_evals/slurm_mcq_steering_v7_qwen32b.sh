#!/bin/bash
#SBATCH --job-name=mcq_v7_32b
#SBATCH --output=slurm_jobs/mcq_v7_32b_%j.out
#SBATCH --error=slurm_jobs/mcq_v7_32b_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting MCQ v7 experiment on Qwen 32B"
...
python experiments/behavior_tests/mcq_evals/mcq_emotion_steering_experiment.py \
    ...
    --prompts experiments/behavior_tests/mcq_evals/prompts_v7.json \
