...
#SBATCH --mem=120G
#SBATCH --job-name=priority_32b_ext
#SBATCH --output=/workspace-vast/annas/logs/%j_priority_qwen32b_extended.out
#SBATCH --error=/workspace-vast/annas/logs/%j_priority_qwen32b_extended.err
#SBATCH --time=4:00:00

set -e

echo "=========================================="
echo "PRIORITY SELECTION STEERING: Qwen3-32B"
