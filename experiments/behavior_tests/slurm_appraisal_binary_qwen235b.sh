#!/bin/bash
#SBATCH --job-name=appr_bin_q235
#SBATCH --output=/workspace-vast/annas/logs/%j_appraisal_binary_qwen235b.out
#SBATCH --error=/workspace-vast/annas/logs/%j_appraisal_binary_qwen235b.err
...
echo "=========================================="
echo "BINARY APPRAISAL STEERING: Qwen3-235B"
