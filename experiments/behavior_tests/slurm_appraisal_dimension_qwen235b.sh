...
#SBATCH --mem=320G
#SBATCH --job-name=appr_dim_235b
#SBATCH --output=/workspace-vast/annas/logs/%j_appraisal_dimension_qwen235b.out
#SBATCH --error=/workspace-vast/annas/logs/%j_appraisal_dimension_qwen235b.err
#SBATCH --time=6:00:00

set -e

echo "=========================================="
echo "APPRAISAL DIMENSION STEERING: Qwen3-235B"
