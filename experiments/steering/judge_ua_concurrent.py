#!/usr/bin/env python3
"""Judge UA model results using concurrent API with exact same prompt as text meandiff."""
import sys
...
INPUT_FILE = "experiments/steering/outputs/sandbagging_ua_model_layer30_20260113_143516.jsonl"
OUTPUT_FILE = "experiments/steering/outputs/judged_ua_model_layer30_proper.jsonl"
