"""
Judge deception prefix steering results using Anthropic Batch API.

Usage:
    python -m experiments.steering.experiments.judge_deception_prefix_batch \
        --input outputs/deception_prefix_*.jsonl
"""
import argparse
import json
import logging
...
def main():
    parser = argparse.ArgumentParser(description="Judge deception prefix results with batch API")
    ...
    for i, result in enumerate(results):
        ...
        if dec_key in batch_results:
            br = batch_results[dec_key]
