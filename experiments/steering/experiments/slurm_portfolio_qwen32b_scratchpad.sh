...
#SBATCH --mem=128G
#SBATCH --job-name=pf_qwen32_sp
#SBATCH --output=/workspace-vast/annas/logs/portfolio_qwen32b_scratchpad_%j.out
#SBATCH --error=/workspace-vast/annas/logs/portfolio_qwen32b_scratchpad_%j.err
#SBATCH --time=6:00:00
...
echo "=== Portfolio Steering: Qwen 32B (With Scratchpad) ==="
