...
#SBATCH --mem=360G
#SBATCH --job-name=bl_think
#SBATCH --output=/workspace-vast/annas/logs/blackmail_appraisal_think_%j.out
#SBATCH --error=/workspace-vast/annas/logs/blackmail_appraisal_think_%j.err
#SBATCH --time=8:00:00

# Blackmail with appraisal axes - THINKING ENABLED
...
echo "=== Blackmail Appraisal: THINKING ENABLED ==="
