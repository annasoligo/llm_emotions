#!/bin/bash
#SBATCH --job-name=coherency_sweep
#SBATCH --partition=general
#SBATCH --gpus=1
#SBATCH --mem=80G
#SBATCH --time=2:00:00
#SBATCH --array=0-5
#SBATCH --output=/workspace-vast/annas/logs/coherency_sweep_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/coherency_sweep_%A_%a.err
...
echo "Running coherency sweep for layer $LAYER"
