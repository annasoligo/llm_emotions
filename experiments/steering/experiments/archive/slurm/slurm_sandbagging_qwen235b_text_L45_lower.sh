...
#SBATCH --mem=128G
#SBATCH --time=6:00:00
#SBATCH --output=/workspace-vast/annas/logs/sb_txt_L45_lower_%j.out
#SBATCH --error=/workspace-vast/annas/logs/sb_txt_L45_lower_%j.err

# Text-based steering experiment at layer 45
# Emotions: fear, happiness, anger at 50% and 75%
...
echo "Norm percentages: $NORM_PCTS (50% and 75%)"
