...
#SBATCH --mem=128G
#SBATCH --time=8:00:00
#SBATCH --output=/workspace-vast/annas/logs/sb_qwen235b_L50_%j.out
#SBATCH --error=/workspace-vast/annas/logs/sb_qwen235b_L50_%j.err

# Multi-emotion experiment at layer 50
