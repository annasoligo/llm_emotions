"""
Sycophancy steering experiment for OLMo-3-32B.
...
def run_experiment(
    ...
    """Run sycophancy steering experiment on OLMo-3-32B."""
    ...
    # Load layer norm from centralized file - will fail if OLMo not yet added
    layer_norm = get_layer_norm("olmo", layer)
    ...
    output_file = output_dir / f"sycophancy_steering_olmo_layer{layer}_{timestamp}.jsonl"
...
def main():
    parser = argparse.ArgumentParser(description="Sycophancy steering for OLMo-3-32B")
