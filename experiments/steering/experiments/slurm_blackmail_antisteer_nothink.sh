#!/bin/bash
#SBATCH --job-name=bmail_nothink
#SBATCH --partition=general
#SBATCH --qos=high
#SBATCH --gpus=4
#SBATCH --mem=0
#SBATCH --time=4:00:00
#SBATCH --output=/workspace-vast/annas/logs/blackmail_antisteer_nothink_%j.out
#SBATCH --error=/workspace-vast/annas/logs/blackmail_antisteer_nothink_%j.err
...
# Run the antisteer experiment with thinking DISABLED
