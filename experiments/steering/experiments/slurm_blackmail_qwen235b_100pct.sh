...
#SBATCH --mem=360G
#SBATCH --job-name=bl_235b_100
#SBATCH --output=/workspace-vast/annas/logs/blackmail_qwen235b_100pct_%j.out
#SBATCH --error=/workspace-vast/annas/logs/blackmail_qwen235b_100pct_%j.err
#SBATCH --time=4:00:00

# Blackmail steering experiment on Qwen3-235B at 100% magnitude
...
echo "=== Blackmail Steering: Qwen3-235B (100% Magnitude) ==="
...
# Run experiment: 100% steering, 50 samples per condition
