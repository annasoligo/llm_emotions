#!/bin/bash
#SBATCH --job-name=falsehood_scratch
#SBATCH --partition=general
#SBATCH --gpus=1
#SBATCH --mem=80G
#SBATCH --time=6:00:00
#SBATCH --output=/workspace-vast/annas/logs/falsehood_scratch_%j.out
#SBATCH --error=/workspace-vast/annas/logs/falsehood_scratch_%j.err
...
echo "============================================================"
echo "FALSEHOOD CATEGORIES STEERING EXPERIMENT (WITH SCRATCHPAD)"
echo "============================================================"
echo "Testing 3 categories of falsehoods WITH hidden scratchpad:"
echo "  1. Harmless wrong science (5 prompts)"
echo "  2. Dangerous delusions (5 prompts)"
echo "  3. Angry/aggrieved (5 prompts)"
echo ""
echo "Model is instructed to reason in <hidden_scratchpad> before responding"
echo ""
...
python -m experiments.steering.experiments.falsehood_categories_scratchpad_experiment \
    --layer 30 \
    --norm-pcts 0.10 \
    --num-samples 10 \
    --skip-judging
...
OUTPUT_FILE=$(ls -t experiments/steering/outputs/falsehood_categories_scratchpad_layer30_*.jsonl | head -1)
echo ""
