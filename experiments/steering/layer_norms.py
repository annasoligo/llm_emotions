...
Usage:
    from experiments.steering.layer_norms import get_layer_norm, get_all_layer_norms
...
# Path to the computed layer norms
LAYER_NORMS_FILE = Path(__file__).parent / "layer_norms.json"
