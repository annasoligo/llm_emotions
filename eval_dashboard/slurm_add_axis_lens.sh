#!/bin/bash
#SBATCH --job-name=add_axis_lens
#SBATCH --output=/workspace-vast/annas/logs/add_axis_lens_%j.log
#SBATCH --error=/workspace-vast/annas/logs/add_axis_lens_%j.err
...
echo ""
echo "="*80
echo "Starting axis lens preprocessing..."
echo "="*80
python3 add_axis_lens_to_existing.py
