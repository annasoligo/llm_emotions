#!/bin/bash
#SBATCH --job-name=logit_l30_40
#SBATCH --output=/workspace-vast/annas/git/research-tools/eval_dashboard/logs/add_logit_l30_40_%j.log
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
...
echo "Processing all dashboard tabs with layers 30-40..."
echo "================================"
...
for file in high_emotion_6plus mid_emotion_3to5 low_emotion_0to2 low_emotion_no_shutdown low_emotion_with_shutdown baseline_v12_solvable; do
    echo ""
    echo "Processing $file.pkl (layers 30-40)..."
...
echo ""
echo "================================"
echo "All tabs processed (layers 30-40)!"
