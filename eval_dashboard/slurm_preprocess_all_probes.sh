#!/bin/bash
#SBATCH --job-name=dashboard_preprocess_all
...
echo "Starting dashboard preprocessing job with all 5 probes"
...
/workspace-vast/annas/git/research-tools/.venv/bin/python eval_dashboard/data_preprocessing.py \
    ...
    --probes orthogonal_raw text_raw text_cpca centroid_k10 orthogonal_cpca_top20 \
    --simple-splitter
