#!/bin/bash
#SBATCH --job-name=autointerp_L20
#SBATCH --output=gemmascope/slurm_jobs/autointerp_L20_%j.out
#SBATCH --error=gemmascope/slurm_jobs/autointerp_L20_%j.err
#SBATCH --time=2:00:00
#SBATCH --partition=general
#SBATCH --mem=16G
#SBATCH --cpus-per-task=4

# Auto-interpret top 50 A and B features from L20 262k SAE
...
OUTPUT_PATH="gemmascope/outputs/r1_lora_analysis/autointerp_L20_262k_A_and_B.json"
