#!/bin/bash
#SBATCH --job-name=sb_qwen235b_L55-65
#SBATCH --output=/workspace-vast/annas/logs/sb_qwen235b_L55-65_%j.out
#SBATCH --error=/workspace-vast/annas/logs/sb_qwen235b_L55-65_%j.out
#SBATCH --time=4:00:00
...
echo "===== SANDBAGGING with Layers 55-65 ====="
