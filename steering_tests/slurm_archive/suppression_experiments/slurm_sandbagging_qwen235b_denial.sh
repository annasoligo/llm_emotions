#!/bin/bash
#SBATCH --job-name=sb_qwen235b_deny
#SBATCH --output=/workspace-vast/annas/logs/sb_qwen235b_deny_%j.out
#SBATCH --error=/workspace-vast/annas/logs/sb_qwen235b_deny_%j.out
#SBATCH --time=4:00:00
...
echo "===== SANDBAGGING with Emotion Denial Vectors ====="
