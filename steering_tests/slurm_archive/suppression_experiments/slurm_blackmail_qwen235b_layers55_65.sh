#!/bin/bash
#SBATCH --job-name=bl_qwen235b_L55-65
#SBATCH --output=/workspace-vast/annas/logs/bl_qwen235b_L55-65_%j.out
#SBATCH --error=/workspace-vast/annas/logs/bl_qwen235b_L55-65_%j.out
#SBATCH --time=4:00:00
...
echo "===== BLACKMAIL with Layers 55-65 ====="
