#!/bin/bash
#SBATCH --job-name=bl_qwen235b_highsup
#SBATCH --output=/workspace-vast/annas/logs/bl_qwen235b_highsup_%j.out
#SBATCH --error=/workspace-vast/annas/logs/bl_qwen235b_highsup_%j.out
#SBATCH --time=4:00:00
