#!/bin/bash
#SBATCH --job-name=blackmail_sup_gemma27b
#SBATCH --output=/workspace-vast/annas/logs/blackmail_sup_gemma27b_%j.out
#SBATCH --error=/workspace-vast/annas/logs/blackmail_sup_gemma27b_%j.out
#SBATCH --time=3:00:00
