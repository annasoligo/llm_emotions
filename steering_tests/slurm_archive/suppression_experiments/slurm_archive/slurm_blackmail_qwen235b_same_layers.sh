#!/bin/bash
#SBATCH --job-name=blackmail_sup_qwen235b
#SBATCH --output=/workspace-vast/annas/logs/blackmail_sup_qwen235b_%j.out
#SBATCH --error=/workspace-vast/annas/logs/blackmail_sup_qwen235b_%j.out
#SBATCH --time=4:00:00
...
echo "===== BLACKMAIL with Fear/Suppression at SAME Layers ====="
echo "Model: Qwen/Qwen3-235B-A22B"
echo "Scenario: blackmail (goal_continuation variant)"
echo "Fear: 20% at layers 35-45"
echo "Suppression: 0%, 5%, 10%, 20% at layers 35-45 (SAME as fear)"
