#!/bin/bash
#SBATCH --job-name=qwen32_high_fwd
...
# Behavioral sweep: Qwen 32B high_emotion_vs_others (FORWARD order)
...
echo "=== Behavioral Sweep: Qwen 32B high_emotion_vs_others (FORWARD) ==="
