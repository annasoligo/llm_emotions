#!/bin/bash
#SBATCH --job-name=qwen32_txt_opp_fwd
...
# Behavioral sweep: Qwen 32B text_pairs_emotion_vs_opposite (FORWARD order)
...
echo "=== Behavioral Sweep: Qwen 32B text_pairs_emotion_vs_opposite (FORWARD) ==="
