#!/bin/bash
#SBATCH --job-name=qwen32_high_rev
...
# Behavioral sweep: Qwen 32B high_emotion_vs_others (REVERSED order)
...
echo "=== Behavioral Sweep: Qwen 32B high_emotion_vs_others (REVERSED) ==="
...
python -m steering_tests.vector_testing.behavioral_shift \
    ...
    --vector-dir steering_tests/vectors/qwen32b/high_emotion_vs_others \
