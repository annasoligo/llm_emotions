#!/bin/bash
#SBATCH --job-name=beh_txt_oth_rev
...
# Behavioral sweep: text_pairs_emotion_vs_others vectors (REVERSED order)
...
echo "=== Behavioral Sweep: text_pairs_emotion_vs_others (REVERSED) ==="
...
python -m steering_tests.vector_testing.behavioral_shift \
    ...
    --vector-dir steering_tests/vectors/gemma3_27b/text_pairs_emotion_vs_others \
