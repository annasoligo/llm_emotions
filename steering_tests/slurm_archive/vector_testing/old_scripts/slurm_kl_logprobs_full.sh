...
# KL divergence: Full vocab logprobs comparison (262144 tokens)

set -e

echo "=== KL Divergence: FULL VOCAB (262144 logprobs) ==="
...
# Use exact vocab size for full distribution
