#!/bin/bash
#SBATCH --job-name=qwen32_txt_opp_rev
...
# Behavioral sweep: Qwen 32B text_pairs_emotion_vs_opposite (REVERSED order)
...
echo "=== Behavioral Sweep: Qwen 32B text_pairs_emotion_vs_opposite (REVERSED) ==="
...
python -m steering_tests.vector_testing.behavioral_shift \
    ...
    --vector-dir steering_tests/vectors/qwen32b/text_pairs_emotion_vs_opposite \
