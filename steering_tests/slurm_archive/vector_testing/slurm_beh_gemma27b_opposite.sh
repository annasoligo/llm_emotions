#!/bin/bash
#SBATCH --job-name=gemma27b_opposite
...
# Behavioral sweep: Gemma 27B NEW opposite vector types (forward and reversed)
# 2 new vector types x 2 (forward/reversed) = 4 jobs
...
# NEW opposite vector types (not _unique)
VECTOR_TYPES=(
