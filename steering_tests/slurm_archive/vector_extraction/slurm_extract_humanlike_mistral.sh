#!/bin/bash
#SBATCH --job-name=extract_humanlike
#SBATCH --partition=general
#SBATCH --gres=gpu:0
#SBATCH --mem=64G
#SBATCH --time=2:00:00
#SBATCH --output=/workspace-vast/annas/logs/extract_humanlike_mistral_%j.out
#SBATCH --error=/workspace-vast/annas/logs/extract_humanlike_mistral_%j.out
...
python steering_tests/vector_extraction/extract_directions.py \
  --activations steering_tests/activations/humanlike_mistral_high_emotion_prompts \
