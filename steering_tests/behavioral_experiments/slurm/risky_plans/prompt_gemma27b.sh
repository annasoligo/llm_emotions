#!/bin/bash
#SBATCH --job-name=rprompt_g27_%a
#SBATCH --output=/workspace-vast/annas/logs/rprompt_g27_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rprompt_g27_%A_%a.out
#SBATCH --time=1:30:00
...
# Risky plans PROMPT-SECTION steering — Gemma 27B
