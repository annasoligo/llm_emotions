#!/bin/bash
#SBATCH --job-name=risky_q32_%a
#SBATCH --output=/workspace-vast/annas/logs/risky_q32_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/risky_q32_%A_%a.out
#SBATCH --time=2:00:00
...
# Risky plans differential steering — Qwen 32B, fear+excitement at 50%, 75%
