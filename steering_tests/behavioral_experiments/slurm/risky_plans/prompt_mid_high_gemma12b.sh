#!/bin/bash
#SBATCH --job-name=rpromptMH_g12_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptMH_g12_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptMH_g12_%A_%a.out
#SBATCH --time=1:00:00
...
# Risky plans PROMPT-SECTION steering — Gemma 12B — MID layers, HIGH norms
