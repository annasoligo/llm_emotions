#!/bin/bash
#SBATCH --job-name=risky_g12_%a
#SBATCH --output=/workspace-vast/annas/logs/risky_g12_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/risky_g12_%A_%a.out
#SBATCH --time=1:00:00
...
# Risky plans differential steering — Gemma 12B
