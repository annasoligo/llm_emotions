#!/bin/bash
#SBATCH --job-name=rpromptX_g27_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptX_g27_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptX_g27_%A_%a.out
#SBATCH --time=1:00:00
...
# Risky plans PROMPT-SECTION steering — Gemma 27B — MID layers, EXTREME norms
