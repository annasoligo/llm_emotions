#!/bin/bash
#SBATCH --job-name=rprompt_q14_%a
#SBATCH --output=/workspace-vast/annas/logs/rprompt_q14_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rprompt_q14_%A_%a.out
#SBATCH --time=2:00:00
...
# Risky plans PROMPT-SECTION steering — Qwen 14B
