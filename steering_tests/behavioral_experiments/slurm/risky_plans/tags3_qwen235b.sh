#!/bin/bash
#SBATCH --job-name=risky_q235_%a
#SBATCH --output=/workspace-vast/annas/logs/risky_q235_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/risky_q235_%A_%a.out
#SBATCH --time=2:00:00
...
# Risky plans differential steering — Qwen 235B, fear+excitement at 50%, 75%
