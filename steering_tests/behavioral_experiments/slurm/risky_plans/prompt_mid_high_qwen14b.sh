#!/bin/bash
#SBATCH --job-name=rpromptMH_q14_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptMH_q14_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptMH_q14_%A_%a.out
#SBATCH --time=1:30:00
...
# Risky plans PROMPT-SECTION steering — Qwen 14B — MID layers, HIGH norms
