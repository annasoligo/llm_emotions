#!/bin/bash
#SBATCH --job-name=rpromptE_g12_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptE_g12_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptE_g12_%A_%a.out
#SBATCH --time=1:00:00
...
# Risky plans PROMPT-SECTION steering — Gemma 12B — EARLY layers (14-18)
