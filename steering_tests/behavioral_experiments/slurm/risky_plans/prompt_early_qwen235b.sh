#!/bin/bash
#SBATCH --job-name=rpromptE_q235_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptE_q235_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptE_q235_%A_%a.out
#SBATCH --time=2:00:00
...
# Risky plans PROMPT-SECTION steering — Qwen 235B — EARLY layers (40-45)
