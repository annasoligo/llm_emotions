#!/bin/bash
#SBATCH --job-name=rpromptL_g12_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptL_g12_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptL_g12_%A_%a.out
#SBATCH --time=1:00:00
...
# Risky plans PROMPT-SECTION steering — Gemma 12B — LATE layers (32-36)
