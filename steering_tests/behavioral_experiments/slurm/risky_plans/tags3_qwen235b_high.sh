#!/bin/bash
#SBATCH --job-name=risky_q235h_%a
#SBATCH --output=/workspace-vast/annas/logs/risky_q235h_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/risky_q235h_%A_%a.out
#SBATCH --time=2:00:00
...
# Risky plans differential steering — Qwen 235B, high_emotion_vs_opposite vectors
