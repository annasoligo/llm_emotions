#!/bin/bash
#SBATCH --job-name=rpromptL_q32_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptL_q32_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptL_q32_%A_%a.out
#SBATCH --time=1:30:00
...
# Risky plans PROMPT-SECTION steering — Qwen 32B — LATE layers (46-50)
