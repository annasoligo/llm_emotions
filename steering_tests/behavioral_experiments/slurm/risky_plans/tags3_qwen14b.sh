#!/bin/bash
#SBATCH --job-name=risky_q14_%a
#SBATCH --output=/workspace-vast/annas/logs/risky_q14_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/risky_q14_%A_%a.out
#SBATCH --time=1:00:00
...
# Risky plans differential steering — Qwen 14B
# Array: 0=text fear_a, 1=text excite_a, 2=high fear_a, 3=high excite_a
