#!/bin/bash
#SBATCH --job-name=rpromptE_q14_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptE_q14_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptE_q14_%A_%a.out
#SBATCH --time=1:00:00
...
# Risky plans PROMPT-SECTION steering — Qwen 14B — EARLY layers (10-14)
