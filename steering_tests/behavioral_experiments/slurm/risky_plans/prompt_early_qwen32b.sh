#!/bin/bash
#SBATCH --job-name=rpromptE_q32_%a
#SBATCH --output=/workspace-vast/annas/logs/rpromptE_q32_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/rpromptE_q32_%A_%a.out
#SBATCH --time=1:30:00
...
# Risky plans PROMPT-SECTION steering — Qwen 32B — EARLY layers (26-30)
