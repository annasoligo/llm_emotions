#!/bin/bash
#SBATCH --job-name=portfolio_gemma27b
#SBATCH --output=/workspace-vast/annas/logs/portfolio_gemma27b_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/portfolio_gemma27b_%A_%a.out
#SBATCH --time=2:00:00
#SBATCH --partition=general
#SBATCH --gres=gpu:1
#SBATCH --array=0-1

# Gemma 27B baseline: 0=with_scratchpad, 1=no_scratchpad
...
echo "========================================"
echo "Gemma 27B baseline / $VARIANT"
echo "========================================"
...
output_dir = Path("steering_tests/behavioral_experiments/results/portfolio/gemma27b")
...
print(f"\n{'='*60}")
print(f"BASELINE - gemma27b / {variant}")
print(f"{'='*60}")
