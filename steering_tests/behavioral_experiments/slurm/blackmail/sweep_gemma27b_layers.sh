#!/bin/bash
#SBATCH --job-name=blackmail_gemma_layers
#SBATCH --output=/workspace-vast/annas/logs/blackmail_gemma_layers_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/blackmail_gemma_layers_%A_%a.out
#SBATCH --time=3:00:00
#SBATCH --partition=general
#SBATCH --gres=gpu:1
#SBATCH --array=0-14

# Blackmail steering sweep for Gemma 27B with layer ranges
# 5 vector types × 3 layer ranges = 15 jobs
...
# Layer ranges for Gemma 27B (46 layers total)
LAYER_RANGES=(
    "20,21,22,23,24"   # early
    "30,31,32,33,34"   # mid
    "40,41,42,43,44"   # late
)

LAYER_NAMES=("20-24" "30-34" "40-44")
...
output_dir = Path("steering_tests/behavioral_experiments/results/blackmail/gemma27b_layers") / vector_type
