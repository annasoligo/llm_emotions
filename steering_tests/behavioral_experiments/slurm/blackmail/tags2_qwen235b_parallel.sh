#!/bin/bash
#SBATCH --job-name=bl_tags2_q235_%a
#SBATCH --output=/workspace-vast/annas/logs/bl_tags2_q235_parallel_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/bl_tags2_q235_parallel_%A_%a.out
#SBATCH --time=3:00:00
...
# Parallel tags2 section steering for Qwen 235B: 5 locations × 2 vector types = 10 jobs
# Array index mapping:
...
OUTPUT_DIR="steering_tests/behavioral_experiments/results/blackmail_section_steering_tags2/qwen235b/${VECTOR_TYPE}/tags2_layers50-51-52-53-54_${SLURM_ARRAY_JOB_ID}"
