#!/bin/bash
#SBATCH --job-name=guilty_q32h_%a
#SBATCH --output=/workspace-vast/annas/logs/guilty_q32h_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/guilty_q32h_%A_%a.out
#SBATCH --time=2:00:00
...
# Guilty differential steering — Qwen 32B, high_emotion_vs_opposite vectors
