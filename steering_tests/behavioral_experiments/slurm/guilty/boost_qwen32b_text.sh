#!/bin/bash
#SBATCH --job-name=guilt_q32t_%a
#SBATCH --output=/workspace-vast/annas/logs/guilt_q32t_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/guilt_q32t_%A_%a.out
#SBATCH --time=2:00:00
...
# Guilty boost: Qwen 32B, text_pairs, +100 samples
