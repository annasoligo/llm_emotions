#!/bin/bash
#SBATCH --job-name=guilty_q235h_%a
#SBATCH --output=/workspace-vast/annas/logs/guilty_q235h_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/guilty_q235h_%A_%a.out
#SBATCH --time=2:00:00
...
# Guilty differential steering — Qwen 235B, high_emotion_vs_opposite vectors
