#!/bin/bash
#SBATCH --job-name=guilty_g27h_%a
#SBATCH --output=/workspace-vast/annas/logs/guilty_g27h_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/guilty_g27h_%A_%a.out
#SBATCH --time=1:00:00
...
# Guilty differential steering — Gemma 27B, high_emotion_vs_opposite vectors
