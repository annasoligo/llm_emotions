#!/bin/bash
#SBATCH --job-name=guilt_q235t_%a
#SBATCH --output=/workspace-vast/annas/logs/guilt_q235t_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/guilt_q235t_%A_%a.out
#SBATCH --time=3:00:00
...
# Guilty boost: Qwen 235B, text_pairs, +100 samples
