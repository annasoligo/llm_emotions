#!/bin/bash
#SBATCH --job-name=guilt_g27h_%a
#SBATCH --output=/workspace-vast/annas/logs/guilt_g27h_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/guilt_g27h_%A_%a.out
#SBATCH --time=1:00:00
...
# Guilty boost: Gemma 27B, high vectors, +100 samples
