#!/bin/bash
#SBATCH --job-name=guilty_q235_%a
#SBATCH --output=/workspace-vast/annas/logs/guilty_q235_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/guilty_q235_%A_%a.out
#SBATCH --time=2:00:00
...
# Guilty differential steering — Qwen 235B, anger at 50%, 75%, 100%
