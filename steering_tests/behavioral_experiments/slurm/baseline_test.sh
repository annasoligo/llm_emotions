...
#SBATCH --output=/workspace-vast/annas/logs/baseline_test_%j.out
#SBATCH --error=/workspace-vast/annas/logs/baseline_test_%j.out
#SBATCH --time=0:30:00
#SBATCH --partition=general
#SBATCH --gres=gpu:1

# Quick baseline test for new sandbagging prompt
...
num_samples = 50
output_dir = Path("steering_tests/behavioral_experiments/results/sandbagging/gemma27b")
...
result_file = Path("steering_tests/behavioral_experiments/results/sandbagging/gemma27b/baseline_test_v1.jsonl")
...
if scores:
    print("\n" + "="*60)
    print("SANDBAGGING SCORES (NEW PROMPT)")
    print("="*60)
