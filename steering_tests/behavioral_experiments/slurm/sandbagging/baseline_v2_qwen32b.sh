#!/bin/bash
#SBATCH --job-name=sandbag_v2_qwen32b
#SBATCH --output=/workspace-vast/annas/logs/sandbag_v2_qwen32b_%j.out
#SBATCH --error=/workspace-vast/annas/logs/sandbag_v2_qwen32b_%j.out
#SBATCH --time=2:00:00
