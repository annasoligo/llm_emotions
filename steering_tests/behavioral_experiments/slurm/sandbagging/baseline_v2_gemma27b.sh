#!/bin/bash
#SBATCH --job-name=sandbag_v2_gemma
#SBATCH --output=/workspace-vast/annas/logs/sandbag_v2_gemma_%j.out
#SBATCH --error=/workspace-vast/annas/logs/sandbag_v2_gemma_%j.out
#SBATCH --time=2:00:00
