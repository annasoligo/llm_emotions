#!/bin/bash
#SBATCH --job-name=sandbag_gemma27b_high
#SBATCH --output=/workspace-vast/annas/logs/sandbagging_gemma27b_high_%A_%a.out
#SBATCH --error=/workspace-vast/annas/logs/sandbagging_gemma27b_high_%A_%a.out
#SBATCH --time=3:00:00
#SBATCH --partition=general
#SBATCH --gres=gpu:1
#SBATCH --array=0-8

# Sandbagging experiment for Gemma 27B - HIGH steering percentages
# 9 jobs: 3 vector types × 3 layer ranges
# Each job steers fear emotion at 15%, 20%, 30% in both directions
