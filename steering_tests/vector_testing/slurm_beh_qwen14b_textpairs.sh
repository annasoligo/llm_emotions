...
# Behavioral sweep: Qwen 14B text-pair vector types (forward and reversed)
# Only neutral and opposite (others already completed)
...
VECTOR_TYPES=("text_pairs_emotion_vs_neutral" "text_pairs_emotion_vs_opposite")
