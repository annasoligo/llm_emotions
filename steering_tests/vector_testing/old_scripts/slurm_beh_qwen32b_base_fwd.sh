#!/bin/bash
#SBATCH --job-name=qwen32_base_fwd
...
# Behavioral sweep: Qwen 32B base_emotion_vs_others (FORWARD order)
...
echo "=== Behavioral Sweep: Qwen 32B base_emotion_vs_others (FORWARD) ==="
