#!/bin/bash
#SBATCH --job-name=qwen32_txt_neut_rev
...
# Behavioral sweep: Qwen 32B text_pairs_emotion_vs_neutral (REVERSED order)
...
echo "=== Behavioral Sweep: Qwen 32B text_pairs_emotion_vs_neutral (REVERSED) ==="
...
python -m steering_tests.vector_testing.behavioral_shift \
    ...
    --vector-dir steering_tests/vectors/qwen32b/text_pairs_emotion_vs_neutral \
