...
# Behavioral sweep: high_emotion_vs_others vectors (REVERSED order)
...
echo "=== Behavioral Sweep: high_emotion_vs_others (REVERSED) ==="
...
python -m steering_tests.vector_testing.behavioral_shift \
    ...
    --vector-dir steering_tests/vectors/gemma3_27b/high_emotion_vs_others \
