...
# KL divergence with HuggingFace - Qwen 32B
...
echo "=== KL Divergence HF Qwen 32B: Layer ${LAYER}, ${VEC_TYPE} ==="
...
mkdir -p steering_tests/vector_testing/results/qwen2_5_32b_instruct/kl
...
python -m steering_tests.vector_testing.kl_div_hf \
    ...
    --layer ${LAYER} \
    --vector-dir steering_tests/vectors/qwen32b/${VEC_TYPE} \
    --num-samples 50 \
    --num-random 5 \
    --layer-norm-pct 1.0 \
