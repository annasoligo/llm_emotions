#!/bin/bash
#SBATCH --job-name=beh_txt_opp_fwd
...
# Behavioral sweep: text_pairs_emotion_vs_opposite vectors (FORWARD order)
...
echo "=== Behavioral Sweep: text_pairs_emotion_vs_opposite (FORWARD) ==="
