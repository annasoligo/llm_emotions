#!/bin/bash
#SBATCH --job-name=beh_txt_oth_fwd
...
# Behavioral sweep: text_pairs_emotion_vs_others vectors (FORWARD order)
...
echo "=== Behavioral Sweep: text_pairs_emotion_vs_others (FORWARD) ==="
