#!/bin/bash
#SBATCH --job-name=beh_txt_neut_fwd
...
# Behavioral sweep: text_pairs_emotion_vs_neutral vectors (FORWARD order)
...
echo "=== Behavioral Sweep: text_pairs_emotion_vs_neutral (FORWARD) ==="
