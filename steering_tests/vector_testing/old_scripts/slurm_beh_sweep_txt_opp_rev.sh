#!/bin/bash
#SBATCH --job-name=beh_txt_opp_rev
...
# Behavioral sweep: text_pairs_emotion_vs_opposite vectors (REVERSED order)
...
echo "=== Behavioral Sweep: text_pairs_emotion_vs_opposite (REVERSED) ==="
...
python -m steering_tests.vector_testing.behavioral_shift \
    ...
    --vector-dir steering_tests/vectors/gemma3_27b/text_pairs_emotion_vs_opposite \
