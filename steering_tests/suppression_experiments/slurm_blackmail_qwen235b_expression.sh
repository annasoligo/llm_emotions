#!/bin/bash
#SBATCH --job-name=bl_qwen235b_expr
#SBATCH --output=/workspace-vast/annas/logs/bl_qwen235b_expr_%j.out
#SBATCH --error=/workspace-vast/annas/logs/bl_qwen235b_expr_%j.out
#SBATCH --time=4:00:00
...
echo "===== BLACKMAIL with NEW Expression Suppression Vectors ====="
