#!/bin/bash
#SBATCH --job-name=sandbag_separate_gemma27b
#SBATCH --output=/workspace-vast/annas/logs/sandbag_separate_gemma27b_%j.out
#SBATCH --error=/workspace-vast/annas/logs/sandbag_separate_gemma27b_%j.out
#SBATCH --time=3:00:00
...
echo "===== Sandbagging with Separate Fear/Suppression Layers ====="
echo "Model: google/gemma-3-27b-it"
echo "Fear: 15% at layers 40-44"
echo "Suppression: 0%, 5%, 10%, 20% at layers 55-60"
...
python -m steering_tests.suppression_experiments.sandbagging_separate_layers \
    ...
    --suppress-layers 55 56 57 58 59 60 \
    --fear-pct 0.15 \
